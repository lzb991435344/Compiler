...
uint32_t keyboardDriver::HandleInterrupt(uint32_t esp){
	...
	switch(key){
		...
		case 0x05: if(Shift) printf("$"); else printf("5"); break;
		case 0x06: if(Shift) printf("%"); else printf("6"); break;
		case 0x07: if(Shift) printf("&"); else printf("7"); break;
		case 0x08: if(Shift) printf("/"); else printf("4"); break;
